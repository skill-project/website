    ...
    <div id="subpanel">
        <div id="create-skill-panel" class="panel-content">
            ...
            <form method="POST" action="<?= \Controller\Router::url("addSkill"); ?>" id="create-skill-form">
                <input type="hidden" name="skillParentUuid" value="<?= $skill->getUuid(); ?>" />
                <div>
                ...
                <div>
                    ...
                    <div class="img-btn img-btn-l" id="creationTypeParent" data-value="parent">
                        <img src="img/panel-icon-create-before-noborder.png" alt="BEFORE (as a parent)" />
                        <span class="legend">BEFORE (as a parent)</span>
                    </div>
                    <div class="img-btn img-btn-r selected" id="creationTypeChild" data-value="child">
                        <img src="img/panel-icon-create-after-noborder.png" alt="AFTER (as a child)" />
                        <span class="legend">AFTER (as a child)</span>
                    </div>
                </div>
...
<script>
    $(".panel-btn").hover(function(e){
        $(this).find(".arrow-btn-r").stop(true).animate({"margin-left": 36},150);
    }, function(e){
        $(this).find(".arrow-btn-r").stop(true).animate({"margin-left": 24},100);
    });
