...
<section>
    <div class="container">
        ...
        <div class="faq-q">
            ...
            <div class="faq-a">
                <p>It’s anything you can do and is really important to you, in your daily job or in life in general. Even seemingly trivial skills can be really important for some people.</p>
            </div>
        </div>
        <div class="faq-q">
        ...
        <div class="faq-q">
            ...
            <div class="faq-a">
                <p>Sure! Open the Edit panel for any skill and click on “Share”. You will see an URL address you can copy and paste anywhere. By opening that URL, the tree will automatically expand itself up to the selected skill.</p>
            </div>
        </div>
        <div class="faq-q">
            <h4>Is it possible for the same skill to be in two (or more) different branches?</h4>
            <div class="faq-a">
                <p>Yes, absolutely. But as the database is concerned, these will be two different skills (only with the same name). We believe that many skills could have different meanings based on their parent (like “Photo editing”, which could be classified under “Arts” as well as under “Computer Sciences”, or “Technicals”).</p>
            </div>
        </div>
        ...
        <div class="faq-q">
            ...
            <div class="faq-a">
                <p>You have all the editing rights on the skills you just created, but only for an hour... so review your work quickly!</p>
            </div>
        </div>
        ...
        <div class="faq-q">
            ...
            <div class="faq-a">
                <p>Skill Project started a few days ago with a little more than 300 skills. We expect the database to grow quickly into thousands of skills.</p>
            </div>
        </div>
        <div class="faq-q">
            <h4>Where can I download the data?</h4>
            <div class="faq-a">
                <p>We are working on it! If it’s important to you, drop us a line so we can speed up the process as fast as we can.</p>
            </div>
        </div>
        <div class="faq-q">
        ...
        <div class="faq-q">
            ...
            <div class="faq-a">
                <p>It is to collectively make the largest and most accurate database of all the human skills we, as humans, have learned in the last few millenias. And have it organized in such a way that we can easily explore it and keep it up to date.</p>
            </div>
        </div>
        <div class="faq-q">
        ...
        <div class="faq-q">
            ...
            <div class="faq-a">
                <p>We started Skill Project a few days ago and the only Editors then were the 3 core team members.</p>
            </div>
        </div>
...
<section>
    <div class="container">
        ...
        <div class="project-col">
            ...
            <p>Guillaume was born in Quebec, Canada. Passionate web developper and teacher, he fell in love with PHP and sexy databases some 8 years ago. He is known as SkillBill on Skill Project.</p>
        </div>
        <div class="project-col">
