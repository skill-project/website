<?php
    ...
    class Skill extends Entity {
        ...
        public function __construct(Node $node = null){
            ...
            $this->setCapIdealMax(env('CAP_IDEAL_MAX'));
            $this->setCapAlert(env('CAP_ALERT'));
            $this->setCapNoMore(env('CAP_NO_MORE'));
        ...
        public function getJsonData(){
            ...
            if ('en' != 'en'){
                if ($this->getTranslation('en')){
                    $localeName = $this->getTranslation('en');
